    ...
    <div style={{ ...sans, maxWidth: 1100 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginBottom: 24 }}>
        {[
          ...
          <div key={card.title} style={{ background: card.bg, border: `1px solid ${card.border}`, borderRadius: 14, padding: "22px 24px", boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
      ...
      {/* Borough table */}
      <div style={{ background: "#fff", border: "1px solid #E8EDF2", borderRadius: 14, overflow: "hidden", boxShadow: "0 1px 3px rgba(0,0,0,0.04)", marginBottom: 24 }}>
        ...
        {filtered.map((b, i) => {
          ...
          return (
            ...
            >
              ...
              <span style={{ fontSize: 13, fontWeight: 600, color: "#0D2137" }}>{b.borough}</span>
